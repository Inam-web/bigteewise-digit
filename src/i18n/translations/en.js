...
export const en = {
  ...
  // Blog Section - UPDATED with posts array
 blog: {
  ...
  serviceDetailPage: {
    ...
    specializationBadge: "Signature Agency Specialization",
    overviewHeading: "Service Overview & Scope",
    deliverablesHeading: "What is Included in This Service",
    roiHeading: "Expected Business Impact & ROI",
    ctaHeading: "Ready to get started with this service?",
    ctaSubheading: "Book a 1-on-1 strategy call with our service leads to discuss timelines and custom deliverables.",
    requestQuoteBtn: "Request a Proposal for This Service",
    otherServicesHeading: "Explore Complementary Capabilities",
    ...
    deliverablesDesc: "Your package is built around the exact requirements of your {service} goals.",
    ...
    processStep1Label: "DISCOVER",
    processStep1Title: "Discovery & Strategy",
    processStep1Desc: "We analyze your goals for {service} and build a focused roadmap around your audience, positioning, and objectives.",
    processStep2Label: "BUILD",
    processStep2Title: "Execution & Setup",
    processStep2Desc: "Our team develops the creative, strategic, and technical foundation required to execute the service with precision.",
    processStep3Label: "LAUNCH",
    processStep3Title: "Campaign Launch",
    processStep3Desc: "We put the strategy into action across the most relevant channels to create visibility, engagement, and momentum.",
    processStep4Label: "GROW",
    processStep4Title: "Optimization & Growth",
    processStep4Desc: "We monitor performance, identify opportunities, and continuously refine the strategy for stronger long-term results.",
    valuePillar1Title: "Data-Driven",
    valuePillar1Desc: "Every important decision is backed by research, performance signals, and measurable objectives.",
    valuePillar2Title: "Built With Detail",
    valuePillar2Desc: "From strategy to execution, every deliverable is reviewed for quality and brand consistency.",
    valuePillar3Title: "Growth Focused",
    valuePillar3Desc: "The goal is not simply to complete tasks. Every action is designed to create meaningful momentum.",
    valuePillar4Title: "Transparent",
    valuePillar4Desc: "Clear communication and measurable progress keep you informed throughout the entire engagement.",
    faq1Question: "How quickly can we get started with {service}?",
    faq1Answer: "Once we finalize the initial discovery call and brief, setup typically begins within 24–48 hours.",
    faq2Question: "What makes your approach different from other agencies?",
    faq2Answer: "We combine niche specialization with end-to-end execution. You get dedicated strategy, premium creative assets, and performance optimization in one seamless package.",
    faq3Question: "Can this service be customized to my specific budget?",
    faq3Answer: "Yes, we offer flexible tier packages and custom proposals based on your exact objectives and scope.",
    faq4Question: "How do we communicate throughout the project?",
    faq4Answer: "You will have direct access to your project lead with regular milestone updates and responsive email support.",
