...
export default function Hero({ onOpenQuoteModal, onOpenVideoModal }) {
  return (
    <section id="home" className="relative pt-28 sm:pt-36 lg:pt-48 pb-16 sm:pb-24 lg:pb-32 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex max-w-full items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-[11px] sm:text-xs font-semibold tracking-wide uppercase">
              <span className="text-blue-500 font-bold shrink-0">//</span>
              <span className="truncate">Premier Book Marketing & Digital Strategy</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.15] sm:leading-[1.15]">
            ...
            <p className="text-sm sm:text-lg text-slate-300 max-w-2xl font-normal leading-relaxed mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-2.5 sm:gap-3 text-xs sm:text-sm text-slate-300 pt-1">
              <div className="flex items-center justify-center sm:justify-start gap-2 bg-slate-800/80 backdrop-blur-sm px-3.5 py-2 rounded-xl border border-slate-700/60 shadow-sm">
            ...
            {/* Social Proof */}
            <div className="pt-5 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
              <div className="flex -space-x-2 overflow-hidden shrink-0">
                <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full ring-2 ring-slate-900 overflow-hidden">
                  <Image fill src="https://images.pexels.com/photos/5648408/pexels-photo-5648408.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=100&w=100" alt="Client" className="object-cover" />
                </div>
                <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full ring-2 ring-slate-900 overflow-hidden">
                  <Image fill src="https://images.pexels.com/photos/5905895/pexels-photo-5905895.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=100&w=100" alt="Client" className="object-cover" />
                </div>
                <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full ring-2 ring-slate-900 overflow-hidden">
                  <Image fill src="https://images.pexels.com/photos/5905902/pexels-photo-5905902.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=100&w=100" alt="Client" className="object-cover" />
                </div>
              </div>
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              {/* Main Visual Box */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-700/50 group h-[340px] xs:h-[380px] sm:h-[450px]">
                <Image
              ...
              {/* Floating Badge (Top Left) - Adjusted positioning so it doesn't break out of bounds on mobile */}
              <div className="absolute -top-4 -left-2 sm:-top-6 sm:-left-6 bg-white text-slate-900 p-3 sm:p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-2.5 sm:gap-3 z-20">
              ...
              <div className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-6 bg-blue-600 text-white p-3 sm:p-4 rounded-2xl shadow-xl border border-blue-400/30 flex items-center gap-2.5 sm:gap-3 z-20">
